        ...
        <>
            ...
            <div className={styles.left}>
                ...
                <table className={styles.table}>
                        ...
                        <tr className={styles.tr}>
                            ...
                            <td>
                                <span className={styles.id}>5652442</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span className={styles.address}>Dubagga lko UP</span>
                            </td>
                            <td>
            ...
            <div className={styles.wrapper}>
                        ...
                        <div className={styles.totalText}>
                            <b clasName={styles.totalTextTitle}>Subtotal:</b> $79.60
                        </div>
                        <div className={styles.totalText}>
                            <b clasName={styles.totalTextTitle}>Discount:</b> $0.00
                        </div>
                        <div className={styles.totalText}>
                            <b clasName={styles.totalTextTitle}>Total:</b> $79.60
                        </div>
